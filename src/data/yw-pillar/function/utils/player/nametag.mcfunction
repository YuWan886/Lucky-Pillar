scoreboard players display numberformat fishing886_ nametag fixed ["",{bold:true,text:"",extra:[{color:"#d83ea4",text:"哈"},{color:"#d62fbb",text:"基"},{color:"#d51fd2",text:"鱼"},{color:"#d310e9",text:"丸"}]}]
