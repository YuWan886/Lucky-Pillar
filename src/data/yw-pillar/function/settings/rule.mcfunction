...
# 小小的也很可爱
    ...
    execute if score @s TriggerSetting.Rule matches 1 run tellraw @a ["",{text:"效果：",color:"gold"},{text:"所有玩家尺寸缩小为原来的 §l1/3",color:"blue"}]
# 大！大！大！
    ...
    execute if score @s TriggerSetting.Rule matches 2 run tellraw @a ["",{text:"效果：",color:"gold"},{text:"所有玩家尺寸增大为原来的 §l3/2",color:"blue"}]
# 我的伙伴
