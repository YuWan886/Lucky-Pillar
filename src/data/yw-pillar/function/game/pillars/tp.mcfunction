# 羊毛
execute if score #Game MapID matches 101 run function yw-pillar:game/pillars/wool/tp with storage yw-pillar:settings game
# 地狱
execute if score #Game MapID matches 102 in yw-pillar:the_nether_2 run tp @a 0 65 0
execute if score #Game MapID matches 102 run schedule function yw-pillar:utils/pillar/change_dimension 5t
# 玻璃
execute if score #Game MapID matches 103 run function yw-pillar:game/pillars/glass/tp with storage yw-pillar:settings game
# 虚空
...
# 月球
execute if score #Game MapID matches 202 run function yw-pillar:game/pillars/moon/tp with storage yw-pillar:settings game
